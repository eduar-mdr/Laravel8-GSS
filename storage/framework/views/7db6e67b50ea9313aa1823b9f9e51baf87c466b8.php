<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <img src="/promo/<?php echo e($promotion->image); ?>"  class="img-thumbnail " style="width: 20%;" >

        </div>

    </div>
    <div class="box-footer mt20">
        <a href="<?php echo e(route('promotions.index')); ?>" class="btn btn-danger" >Cancelar</a>
...
</script><?php /**PATH C:\xampp\htdocs\Laravel\proLar02\resources\views/promotion/form.blade.php ENDPATH**/ ?>